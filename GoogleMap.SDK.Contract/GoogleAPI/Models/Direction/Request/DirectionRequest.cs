...
namespace GoogleMap.SDK.Contracts.GoogleAPI.Models.Requests
{
    public class DirectionRequest : BaseRequest
    {
        ...
        public DirectionRequest(string origin, string destination, IEnumerable<Avoid> avoids, TrafficMode mode)
        {
